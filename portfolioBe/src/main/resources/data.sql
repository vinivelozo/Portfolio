...
INSERT INTO projects (project_id, project_name, project_description, inventory_image, image_uploaded, project_github)
VALUES ('6e2a5b60-dcf1-11ec-9d64-0242ac120002', 'Watch Store', 'Watchstore-ws is a microservices-based application designed for managing and securing RESTful services using Spring Boot to create a seamless watch store experience. Only backend was made', NULL, NULL, 'https://github.com/vinivelozo/watchstore-ms');

INSERT INTO projects (project_id, project_name, project_description, inventory_image, image_uploaded, project_github)
VALUES ('93f5b9a0-dcf1-11ec-9d64-0242ac120002', 'BusBellos', 'I developed a Unity game using C#, focusing on game mechanics, physics, and user interaction. This project helped me gain hands-on experience with game development concepts, including object-oriented programming, animations, UI design, and collision handling. I also implemented player controls and game logic, making the gameplay more interactive and engaging.', NULL, NULL, 'https://github.com/Iantomasi/busbellos');
